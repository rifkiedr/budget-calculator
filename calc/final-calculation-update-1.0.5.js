...
$("#finish-to-summary").on("click", function() {
    ...
    $("#housing-total-color").css( "background-color", "rgba(248, 210, 52, 1)" );
    $("#transport-total-color").css( "background-color", "rgba(145, 181, 183, 1)" );
    $("#food-total-color").css( "background-color", "rgba(176, 174, 200, 1)" );
    $("#healthcare-total-color").css( "background-color", "rgba(234, 204, 184, 1)" );
    $("#other-total-color").css( "background-color", "rgba(155, 155, 155, 1)" );
        ...
        datasets: [
          {
            label: 'Dataset',
            data: total,
            backgroundColor: "rgba(161, 201, 203, 1)",
            borderColor: 'rgba(161, 201, 203, 1)',
          }
        ]
    };
}