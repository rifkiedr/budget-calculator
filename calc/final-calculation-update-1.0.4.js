...
$("#finish-to-summary").on("click", function() {
    ...
    $("#housing-total-color").css( "background-color", "rgba(197, 199, 101, 1)" );
    $("#transport-total-color").css( "background-color", "rgba(101, 150, 199, 1)" );
    $("#food-total-color").css( "background-color", "rgba(101, 199, 147, 1)" );
    $("#healthcare-total-color").css( "background-color", "rgba(199, 101, 101, 1)" );
    $("#other-total-color").css( "background-color", "rgba(189, 189, 189, 1)" );
        ...
        datasets: [
          {
            label: 'Dataset',
            data: total,
            backgroundColor: 'rgba(197, 199, 101, 1)',
            borderColor: 'rgba(197, 199, 101, 1)',
          }
        ]
    };
}