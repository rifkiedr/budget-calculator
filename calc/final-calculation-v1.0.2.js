...
function __income()
{
    ...
    let employment = parseFloat( reverseFormatNumber( $("#income-calculate #inp-employment").html() ) );
    let saving = parseFloat( reverseFormatNumber( $("#income-calculate #inp-saving").html() ) );
    let pension = parseFloat( reverseFormatNumber( $("#income-calculate #inp-pension").html() ) );
    let benefits = parseFloat( reverseFormatNumber( $("#income-calculate #inp-benefits").html() ) );
    let gift = parseFloat( reverseFormatNumber( $("#income-calculate #inp-gift").html() ) );
    let other = parseFloat( reverseFormatNumber( $("#income-calculate #inp-other").html() ) );
    // set total
