...
function __expenses_details( name )
{
    ...
    _expenses.list.housing.housingCustomValue1 = 0;
    _expenses.list.housing.housingCustomValue2 = 0;
    _expenses.list.housing.housingCustomValue3 = 0;
    _expenses.list.transport.transportCustomValue1 = 0;
    _expenses.list.transport.transportCustomValue2 = 0;
    _expenses.list.transport.transportCustomValue3 = 0;
    _expenses.list.food.foodCustomValue1 = 0;
    _expenses.list.food.foodCustomValue2 = 0;
    _expenses.list.food.foodCustomValue3 = 0;
    _expenses.list.healthcare.healthcareCustomValue1 = 0;
    _expenses.list.healthcare.healthcareCustomValue2 = 0;
    _expenses.list.healthcare.healthcareCustomValue3 = 0;
    _expenses.list.miscellaneous.miscellaneousCustomValue1 = 0;
    _expenses.list.miscellaneous.miscellaneousCustomValue2 = 0;
    _expenses.list.miscellaneous.miscellaneousCustomValue3 = 0;
    _expenses.list.customCategory.customCategoryValue1 = 0;
    _expenses.list.customCategory.customCategoryValue2 = 0;
    _expenses.list.customCategory.customCategoryValue3 = 0;
    _expenses.list.customCategory.customCategoryValue4 = 0;
    _expenses.list.customCategory.customCategoryValue5 = 0;
    _expenses.list.customCategory.customCategoryValue6 = 0;
    // each all input
...
function __listing_expenses()
{
    ...
    $("#expenses-calculate #exp-custom-div input[id]").on("change", function() {
        __expenses_details( "customCategory" );
    });
...
$("#finish-to-summary").on("click", function() {
    ...
    $("#calculate-summary #summary-income").html( new Intl.NumberFormat().format(income.total) );
    $("#calculate-summary #summary-expenses").html( new Intl.NumberFormat().format(expenses.total) );
